...
void    printPage0 (const memMap * buffPtr)
{
    ...
    printf ("central        Addr = %lx, Value = %ld\n", (long) &buffPtr->page0.periscopeBaffle, buffPtr->page0.periscopeBaffle);
    ...
    printf ("pbafdir        Addr = %lx, Value = %ld\n", (long) &buffPtr->page0.pbafdir, buffPtr->page0.pbafdir);
    printf ("pbaf        Addr = %lx, Value = %ld\n", (long) &buffPtr->page0.pbaf, buffPtr->page0.pbaf);
...
void    printPage0Long (const memMap * buffPtr)
{
    ...
    printf ("central         ; %lx ; %ld\n", (long) &buffPtr->page0.periscopeBaffle, (long) buffPtr->page0.periscopeBaffle);
    ...
    printf ("pbafdir         ; %lx ; %ld\n", (long) &buffPtr->page0.pbafdir, (long) buffPtr->page0.pbafdir);
    printf ("pbaf         ; %lx ; %ld\n", (long) &buffPtr->page0.pbaf, (long) buffPtr->page0.pbaf);
